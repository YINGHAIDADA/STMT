...
cfg.TRAIN.FREEZ_BACKBONE = False
...
cfg.TEST.EPOCH = 500
cfg.TEST.UPDATE_LINE = 0.5
cfg.TEST.UPDATE_INTERVALS = edict()
cfg.TEST.UPDATE_INTERVALS.RGBT234 = [10]
cfg.TEST.UPDATE_INTERVALS.LASHERTESTINGSET = [20]
cfg.TEST.UPDATE_INTERVALS.RGBT210 = [20]
